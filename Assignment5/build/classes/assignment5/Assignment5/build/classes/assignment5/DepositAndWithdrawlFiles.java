import assignment5.SavingsAccount;
import java.io.*;
import java.util.Scanner;

/**
   This program demonstrates a solution to the
   Deposit and Withdraw Files programming challenge.
*/
...
public class DepositAndWithdrawlFiles
{
   public static void main(String args[]) throws IOException
   {
      ...
      SavingsAccount savings =new SavingsAccount(500.0, interestRate);

      // Open the Deposits.txt file.
      File file = new File("\\\\storage\\storage$\\732134\\Documents\\NetBeansProjects\\Assignment5\\Data\\Deposits.txt");
